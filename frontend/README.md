...
| 工作台总览 | 推理结果分析 |
| --- | --- |
| ![带模拟数据的工作台总览](showcase/with-mock/01-dashboard-overview.png) | ![带模拟数据的推理结果分析](showcase/with-mock/02-inference-analysis.png) |

![带模拟数据的模型实测效果](showcase/with-mock/03-model-performance.png)

### 不带模拟数据

| 首次启动工作台 | 数据集空状态 |
| --- | --- |
| ![不带模拟数据的工作台](showcase/without-mock/01-dashboard-empty.png) | ![不带模拟数据的数据集页面](showcase/without-mock/02-datasets-empty.png) |

![不带模拟数据的模型空状态](showcase/without-mock/03-models-empty.png)
